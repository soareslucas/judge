...
var handleInteractiveChart = function() {
    ...
    if ($("#interactive-chart").length !== 0) {
        var t = [[11964728e5, 30], [11971548e5, 44], [11972412e5, 55], [1197414e6, 71], [1197846e6, 65], [11979324e5, 87], [11985372e5, 67], [11986236e5, 90], [11992284e5, 110], [11993148e5, 130], [11994876e5, 100], [11999196e5, 105], [12000924e5, 110], [12001788e5, 120], [12006108e5, 130], [120087e7, 135], [1201302e6, 145], [12015612e5, 132], [12019932e5, 123], [12020796e5, 135], [12022524e5, 150], [12026844e5, 145], [12029436e5, 133], [12036212e5, 145]];
        var n = [[11964728e5, 5], [11972412e5, 6], [1197414e6, 10], [1197846e6, 12], [11980188e5, 18], [11985372e5, 20], [11987964e5, 25], [11992284e5, 23], [11994876e5, 24], [11999196e5, 25], [12001788e5, 18], [12006108e5, 30], [120087e7, 25], [1201302e6, 25], [12015612e5, 30], [12020796e5, 27], [12022524e5, 20], [12026844e5, 18], [12029436e5, 31], [1203462e6, 23], [12036212e5, 30]];
        $.plot($("#interactive-chart"), [{data: t, label: "Page Views", color: purple, lines: {show: true, fill: false, lineWidth: 1.5}, points: {show: false, radius: 5, fillColor: "#fff"}, shadowSize: 0}, {data: n, label: "Visitors", color: green, lines: {show: true, fill: false, lineWidth: 1.5, fillColor: ""}, points: {show: false, radius: 3, fillColor: "#fff"}, shadowSize: 0}], {xaxis: {mode: "time", ticks: 15, tickDecimals: 0, tickColor: "rgba(0,0,0,0.2)"}, yaxis: {tickColor: "rgba(0,0,0,0.2)", ticks: 5}, grid: {hoverable: true, clickable: true, tickColor: "rgba(0,0,0,0.2)", borderWidth: 1, backgroundColor: "#fafafa", borderColor: "#ddd"}, legend: {labelBoxBorderColor: "#ddd", margin: 10, noColumns: 1, show: true}});
        var r = null;
...
var handleDonutChart = function() {
    ...
    if ($("#donut-chart").length !== 0) {
        var e = [{label: "Chrome", data: 35, color: purpleDark}, {label: "Firefox", data: 30, color: purple}, {label: "Safari", data: 15, color: purpleLight}, {label: "Opera", data: 10, color: blue}, {label: "IE", data: 5, color: blueDark}];
        $.plot("#donut-chart", e, {series: {pie: {innerRadius: .5, show: true, label: {show: true}}}, legend: {show: true}})
    }
};
var handleDashboardSparkline = function() {
    ...
    var e = {height: "50px", width: "100%", fillColor: "transparent", lineWidth: 2, spotRadius: "4", highlightLineColor: blue, highlightSpotColor: blue, spotColor: false, minSpotColor: false, maxSpotColor: false};
    t();
...
//        setTimeout(function() {
//            $.gritter.add({title: "Welcome back, Admin!", text: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed tempus lacus ut lectus rutrum placerat.", image: "res/user-2.jpg"/*tpa=http://sean-theme.com/color-admin/assets/js/assets/img/user-2.jpg*/, sticky: true, time: "", class_name: "my-sticky-class"})
//        }, 1e3)
//    })
//};
